...
## 2508-0007 controller

优化 @example/simple/docs/mvc-core/controller.md 文档，依据：
1.深度分析 @framework/mvc/core/controller.go 控制器基类
2.分组列出所有的方法，并详细描述
3.完善文档中的示例代码
4.补充常见问题解答
5.添加更多实际应用场景

## 2508-0008 cookie/session

优化 @example/simple/docs/mvc-core/