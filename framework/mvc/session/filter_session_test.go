...
func Test_SessionManagerScenario(t *testing.T) {
	...
	adapter1.store.(*MemoryStore).id = sessionID
	GetSessionStorePool().stores.Store(sessionID, adapter1.store)
...
func Test_SessionConsistencyAcrossRequests(t *testing.T) {
	...
	extension1 := NewExtensionForHertzContext(hertzCtx1)
	...
	extension2 := NewExtensionForHertzContext(hertzCtx2)
	...
	extension3 := NewExtensionForHertzContext(hertzCtx3)
