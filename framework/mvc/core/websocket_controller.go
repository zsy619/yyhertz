// Package core 提供 WebSocket 控制器实现
//
...
func NewWebSocketController(handler define.WsHandlerFunc, upgrader websocket.HertzUpgrader) *WebSocketController {
	return &WebSocketController{
		handler:     handler,
		upgrader:    upgrader,
		connections: make(map[string]*define.WsConn),
	}
}
